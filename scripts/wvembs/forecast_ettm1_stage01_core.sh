...
# 阶段 0/1 核心对照（ETTm1 + Transformer，对齐上游官方脚本超参）
#
# 四组：
# - A：--no_scale + timeF
...
#   例：PRIOR_SCALE="100 100 100 100 100 100 100" bash scripts/wvembs/forecast_ettm1_stage01_core.sh
