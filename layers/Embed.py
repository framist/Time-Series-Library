...
class _ZeroPos(nn.Module):
    def __init__(self):
        super(_ZeroPos, self).__init__()
    def forward(self, _):
        return 0

class DataEmbedding_wo_pos(DataEmbedding):
    """Data Embedding without positional encoding
    use in Autoformer, TimeMixer
    TODO"""
    def __init__(self, *args, **kwargs):
        super(DataEmbedding_wo_pos, self).__init__(*args, **kwargs)
        self.position_embedding = _ZeroPos()
